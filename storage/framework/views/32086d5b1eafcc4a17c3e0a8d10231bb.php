    ...
    <div class="services container">
      ...
      <?php $__currentLoopData = $book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="service-item">
            ...
            <h2><a href="<?php echo e(route('detail',$book->id)); ?>" id="action_book"><?php echo e($book->book_name); ?></a></h2>
  ...
  <section id="services">
    <div class="services container">
      ...
      <?php $__currentLoopData = $new_book; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="service-item">
            <div class="icon"><img src="public/img/dacnhamtam.jpg" /></div>
            <h2><a href="<?php echo e(route('detail',$book->id)); ?>" id="action_book"><?php echo e($data->book_name); ?></a></h2>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis debitis rerum, magni voluptatem sed
              architecto placeat beatae tenetur officia quod</p>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH G:\Xampp\htdocs\DoAnBe_2\resources\views/welcome.blade.php ENDPATH**/ ?>